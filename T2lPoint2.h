...
// <CONSTRUCTION>
    Point2() {}
#ifdef LESS11
    Point2( T x, T y ) : Point<T, 2>( std::array<T, 2>() ) 
	{ Tuple<T, 2>::set(0, x); Tuple<T, 2>::set(1, y); }
    Point2( const Point<T, 2>& other) : Point<T, 2>() 
	{ Tuple<T, 2>::set(0, other.get(0)); Tuple<T, 2>::set(1, other.get(1)); }
#else
